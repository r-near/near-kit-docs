...
```
https://mcp.mintlify.com/near-kit
```
...
<AccordionGroup>
  <Accordion title="llms-full.txt (Recommended)" icon="file">
    ...
    **URL:** [https://near-kit.mintlify.app/llms-full.txt](https://near-kit.mintlify.app/llms-full.txt)

    ```bash
    curl https://near-kit.mintlify.app/llms-full.txt
    ```
  </Accordion>
  ...
  <Accordion title="llms.txt (Index Only)" icon="list">
    ...
    **URL:** [https://near-kit.mintlify.app/llms.txt](https://near-kit.mintlify.app/llms.txt)
  </Accordion>
</AccordionGroup>
...
<Tabs>
  <Tab title="Cursor / Windsurf">
    ...
    2. Type `@Docs` and add the URL: `https://near-kit.mintlify.app/llms-full.txt`
  ...
  <Tab title="Claude Desktop">
    ...
    2. Add the MCP server: `https://mcp.mintlify.com/near-kit`
  ...
  <Tab title="ChatGPT">
    1. Paste the URL in your chat: `https://near-kit.mintlify.app/llms-full.txt`
